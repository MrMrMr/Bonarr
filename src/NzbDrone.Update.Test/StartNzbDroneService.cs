...
namespace NzbDrone.Update.Test
{
    ...
    public class StartNzbDroneServiceFixture : TestBase<StartNzbDrone>
    {
        ...
        {
            const string targetFolder = "c:\\Bonarr\\";
        ...
        public void should_start_console_if_app_type_was_service_but_start_failed_because_of_permissions()
        {
            ...
            Mocker.GetMock<IProcessProvider>().Verify(c => c.SpawnNewProcess("c:\\Bonarr\\/Bonarr.Console.exe", "/" + StartupContext.NO_BROWSER, null), Times.Once());
