...
namespace NzbDrone.Core.Download.Clients.Sabnzbd
{
    ...
    public class SabnzbdSettings : IProviderConfig
    {
        ...
        [FieldDefinition(5, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Bonarr avoids conflicts with unrelated downloads, but it's optional")]
