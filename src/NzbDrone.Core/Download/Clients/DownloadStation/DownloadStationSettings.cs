...
namespace NzbDrone.Core.Download.Clients.DownloadStation
{
    ...
    public class DownloadStationSettings : IProviderConfig
    {
        ...
        [FieldDefinition(4, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Bonarr avoids conflicts with unrelated downloads, but it's optional. Creates a [category] subdirectory in the output directory.")]
